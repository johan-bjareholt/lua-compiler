...
std::string outBlock(BBlock& block, std::ostream& ss, std::set<std::string>&, std::set<std::string>&, bool exit);
...
void convertThreeAd(ThreeAd& op, std::ostream& ss, std::set<std::string>&, std::set<std::string>&);
